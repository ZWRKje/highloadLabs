...
const (
	Auth_IsAuth_FullMethodName = "/Auth/IsAuth"
)
...
type AuthClient interface {
	IsAuth(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*AuthResp, error)
}
...
func (c *authClient) IsAuth(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*AuthResp, error) {
	out := new(AuthResp)
...
type AuthServer interface {
	IsAuth(context.Context, *UserInfo) (*AuthResp, error)
...
func (UnimplementedAuthServer) IsAuth(context.Context, *UserInfo) (*AuthResp, error) {
...
func _Auth_IsAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).IsAuth(ctx, req.(*UserInfo))
	}
